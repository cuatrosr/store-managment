...
public class JWTAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    private static final String[] excludedPaths = {"POST /account/login", "POST /account/register", "GET /account", "GET /account/roles"};
    ...
    @SneakyThrows
    private void createUnauthorizedFilter(StoreException storeException, HttpServletResponse response) {
        ObjectMapper objectMapper = new ObjectMapper();
        StoreError storeError = storeException.getError();
        String message = objectMapper.writeValueAsString(storeError);

        response.setStatus(storeException.getHttpStatus().value());
